...
const url = `https://newsapi.org/v2/top-headlines?sources=bbc-sport&apiKey=2910e271a09f440ba40f9c51b57aef23`;
...
const Sport = props => (
    <div>
        <h2>Sport from {source.split("-").join(" ")}</h2>
      <div>
      ...
      {props.articles.map(article => (
        <section>
          ...
          <p>{article.content}</p>
          <p><Link href="https://www.breakingnews.ie/sport/">Read More</Link></p>
        </section>
    ))}     
    </div>
