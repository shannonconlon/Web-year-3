...
const url = `https://newsapi.org/v2/top-headlines?sources=business-insider&apiKey=2910e271a09f440ba40f9c51b57aef23`;
    ...
    <div>
      ...
      {props.articles.map(article => (
        <section>
          ...
          <p>{article.content}</p>
          <p><Link href="https://www.independent.ie/business/">Read More</Link></p>
        </section>
    ))}     
    </div>
